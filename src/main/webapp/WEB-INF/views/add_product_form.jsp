...
<body>
	<div class="container mt-5">
		<div class="row">
			...
			<h1 class="text-center py-3 mb-5">Fill the product details</h1>
				<form action="handleform" method="post">
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="description"
							name="productDescription" rows="5" placeholder="Enter the product description here"></textarea>
					</div>
					<div class="form-group">
						<label for="price">Product Price</label> <input
							type="text" id="price" class="form-control" name="productPrice"
